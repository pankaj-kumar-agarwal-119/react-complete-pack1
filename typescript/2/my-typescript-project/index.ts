...
let fixedStr : string = myNum1.toFixed(3);
console.log(`myNum1 : ${fixedStr} | myNum2 : ${myNum2}`);
...
console.log(`The color is : ${col} -- ${typeof col}`);
...
console.log(`City for myApp : ${myAppCity}`);
